...
void model() {
  ...
  while (1) 
  {
    ...
    for (i=0; i<NTRIANGLES; i++) {
      ...
      if (ny<0) ny=0;
      if (nz<0) nz=0;
      color = (0b0010000000000000*(nx>>4) + 0b000000000100000*(ny>>2) + 0b0000000000000001*(nz>>2))&0b1111011111111111 | tft.mask_flag*0x0100;
      //color = (0b0000100001000001*(nx>>2))&0b1111011111110111 | tft.mask_flag*0x0101;
